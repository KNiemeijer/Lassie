...
public class RoundImage extends Drawable {
    ...
    public static final String TAG = "RoundImage";
    ...
    public static RoundImage fromBitmap(Bitmap bitmap) {
        if (bitmap != null) {
    ...
    public static Drawable fromDrawable(Drawable drawable) {
        if (drawable != null) {
            if (drawable instanceof RoundImage) {
                // just return if it's already a RoundImage
                return drawable;
            } else if (drawable instanceof LayerDrawable) {
                LayerDrawable ld = (LayerDrawable) drawable;
                int num = ld.getNumberOfLayers();

                // loop through layers to and change to RoundImages if possible
                for (int i = 0; i < num; i++) {
     ...
     * @return the {@link RoundImage} for chaining.
     */
    public RoundImage setCornerRadius(float radius) {
     ...
     * @return the {@link RoundImage} for chaining.
     */
    public RoundImage setCornerRadius(int corner, float radius) {
     ...
     * @return the {@link RoundImage} for chaining.
     */
    public RoundImage setCornerRadius(float topLeft, float topRight, float bottomRight,
                                      float bottomLeft) {
    ...
    public RoundImage setBorderWidth(float width) {
        mBorderWidth = width;
        mBorderPaint.setStrokeWidth(mBorderWidth);
        return this;
    }
    ...
    public RoundImage setBorderColor(ColorStateList colors) {
        mBorderColor = colors != null ? colors : ColorStateList.valueOf(0);
        mBorderPaint.setColor(mBorderColor.getColorForState(getState(), DEFAULT_BORDER_COLOR));
        return this;
    }

    public RoundImage setBorderColor(int color) {
    ...
    public RoundImage setOval(boolean oval) {
        mOval = oval;
        return this;
    }
    ...
    public RoundImage setScaleType(ScaleType scaleType) {
        if (scaleType == null) {
    ...
    public RoundImage setTileModeX(Shader.TileMode tileModeX) {
    ...
    public RoundImage setTileModeY(Shader.TileMode tileModeY) {
